    ...
    <a href={'/product/' + value.id_product} style={{ color: "black" }}>
      <Card className={'mt-1 mb-1 ' + style.card}>
        ...
        <Card.Body style={{ backgroundColor: "#FAFAFA" }}>
          ...
          <div style={{ fontSize: "0.875rem", fontWeight: "400", color: "#8c8c8c" }}><PersonFill size={12} /> {value.username}</div>
          <div style={{ fontSize: "0.875rem", fontWeight: "400", color: "#8c8c8c" }}><GeoAltFill size={12} /> {value.location}</div>
        </Card.Body>
      </Card>
    </a>
  )
