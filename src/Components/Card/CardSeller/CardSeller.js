...
import { formatCamelCase, formatDate } from '../../../Utils/helper'
        ...
        <a href={'/seller/' + value.username} style={{ color: "black", borderRadius: "8px" }}>
            <Card className={'mt-1 mb-1 ' + style.cardseller}>
                <div className='d-flex ps-3 pe-3'>
                    <div className="d-grid align-items-center justify-content-center"><Card.Img src={value.img} style={{ height: "6rem", width: "6rem" }} /></div>
                    <Card.Body className="d-grid align-items-center">
                        ...
                        <div style={{ fontSize: "0.875rem", fontWeight: "450", color: "#FB374F" }}><GeoAltFill size={11} style={{ marginTop: "-3px" }} /> {formatCamelCase(value.cities.cityName)}</div>
