                ...
                <Row className="m-0">
                    <Col md={8} xs={12} className="p-0">
                        <a href={'/product/' + value.products.productId} className="d-flex gap-3">
                            <div className="my-auto"><img src={value.products.imageProductsSet[0].imageUrl} alt="Photo Product" height="90rem" width="90rem" /></div>
                    ...
                    <Col md={4} xs={12} className="p-0">
                        <div className="d-flex">
                            ...
                            <div className="w-100 d-flex gap-3 mb-2 ps-2 pe-2 ps-md-0 pe-md-0">
                                <a href={'/seller/' + value.products.users.username} className="w-100 d-flex gap-3">
                                    <div className='my-auto'><img src={value.products.users.img} alt="Photo Product" height="50rem" width="50rem" style={{ borderRadius: "8px" }} /></div>
                                    <div className='my-auto w-100'>
                                        <div style={{ color: "black" }}><b>{formatCamelCase(value.products.users.fullName)}</b></div>
                                        <div><span style={{ fontSize: "0.875rem", color: "#8A8A8A" }}>{formatCamelCase(value.products.users.cities.cityName)}</span></div>
                                    </div>
                                </a>
                                <div className={'my-auto ' + style.button_user}><Button variant="outline-secondary" href={'/seller/' + value.products.users.username}>Lihat</Button></div>
                            </div>
                        </div>
                    </Col>
                </Row>
