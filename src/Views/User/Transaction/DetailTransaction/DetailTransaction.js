                    ...
                    <Row className="gap-2">
                        <Col xs={12}>
                            <Row>
                                ...
                                <Col md={9} xs={6}>
                                    <span style={{ color: "#8A8A8A" }}>#TPSG00{dataOffer[0].id_offer}</span>
                                </Col>
                            </Row>
                        </Col>
                        <Col xs={12}>
                        ...
                        <Col xs={12}>
                            {dataOffer[0].status === "pending" ?
                                <div className="pt-2 d-flex gap-2 justify-content-end">
                                    <Button className={style.button_respon} variant="outline-danger">Batalkan Transaksi</Button>
                                    <Button href={'https://wa.me/' + dataOffer[0].user.no_hp} target="_blank" className={style.button_respon} variant="dark">Hubungi Penjual</Button>
                                </div>
                                : null
                            }
