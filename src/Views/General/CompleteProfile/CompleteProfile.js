...
import { getUserVerification, putUserEdit } from '../../../Redux/features/authUser'
...
const CompleteProfile = () => {
    ...
    return (
        dataAllCity && dataUserVerification ?
            <>
                <NavbarBlank />
                <Container fluid>
                            ...
                            <Col xs={12}>
                                ...
                                <Form className={'d-grid gap '} onSubmit={handleSubmit}>
                                    ...
                                    <Form.Group className="mb-3">
                                        ...
                                        <Select options={selectLocation(dataAllCity.data)} theme={StatusAlert.invalid == false ? defaultTheme : errorTheme} placeholder="Kota / Kabupaten" onChange={(e) => setInputForm({ ...InputForm, city: e.value })} />
