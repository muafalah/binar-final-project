                                            ...
                                            <Col xs={12} className="mt-2">
                                                <Row>
                                                    <Col lg={3} md={3} xs={5} className="mt-3">
                                                        {JSON.parse(localStorage.getItem("TokenSecondGadget")) ? null : <Button className="w-100 d-flex align-content-center justify-content-center" size="lg" variant="outline-dark" style={{ fontSize: "1.125rem" }} disabled><HeartFill className='my-auto me-2' size={16} /> Favorit</Button>}
                                                        {dataCheckWishlist ?
                                                    ...
                                                    <Col lg={5} md={5} className="mt-3">
                                                        {dataDetailProduct.data.productStatus === "sold" ? <Button className="w-100 d-flex align-content-center justify-content-center" size="lg" variant="danger" style={{ fontSize: "1.125rem" }} disabled>Tawar Harga</Button> : <Button className="w-100 d-flex align-content-center justify-content-center" size="lg" variant="danger" style={{ fontSize: "1.125rem" }} onClick={() => JSON.parse(localStorage.getItem("TokenSecondGadget")) ? setStatusAlert({ ...StatusAlert, tawarHarga: true }) : navigate("/login")}>Tawar Harga</Button>}
                                                    </Col>
                                                </Row>
                                            </Col>
                                        </Row>
