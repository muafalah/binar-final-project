            ...
            <Container>
                <Row className="mt-3 mb-3">
                    <Col md={12} className="mt-3 ps-4 pe-4">
                        <Row className="ps-3 pe-3 pt-4 pb-4" style={{ backgroundColor: "white", borderRadius: "0.375rem", border: "1px solid rgba(0,0,0,.125)" }}>
                    ...
                    <Col md={12}>
                        <Row>
                            <Tab.Container defaultActiveKey={1}>
                                <Col lg={3} className={'mt-3 ' + style.category_lg}>
                                ...
                                <Col lg={3} className={'mt-4 ' + style.category_sm}>
